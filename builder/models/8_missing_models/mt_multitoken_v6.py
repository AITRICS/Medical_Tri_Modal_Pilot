...
class MT_MULTITOKEN_V6(nn.Module):
    def __init__(self, args):
        ...
        ##### Fusion Part
        self.fusion_transformer = MultiToken_MultimodalTransformerEncoder_sym(
    ...
    def forward(self, x, h, m, d, x_m, age, gen, input_lengths, txts, txt_lengths, img, missing, f_indices):
        ...
        context_vector = [self.layer_norms[i](context_vector[:, i, :]) for i in range(2)]
