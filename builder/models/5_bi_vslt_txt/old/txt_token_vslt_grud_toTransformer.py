...
import math
from builder.models.src.transformer.encoder import TransformerEncoder, BimodalTransformerEncoder
from builder.models.src.transformer.utils import *
from builder.models.src.transformer import *

class TXT_TOKEN_VSLT_GRUD_TOTRANSFORMER(nn.Module):
    ...
    def forward(self, x, h, m, d, x_m, age, gen, input_lengths, txts, txt_lengths):
        ...
        finalOutput, _ = self.final_encoder(finalInputs, first_size = vslt_embedding.size(1), first_lengths = input_lengths + 1, second_lengths = txt_lengths + 2)
