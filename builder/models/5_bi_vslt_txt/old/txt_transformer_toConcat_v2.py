...
class TXT_TRANSFORMER_TOCONCAT_V2(nn.Module):
    ...
    def forward(self, x, h, m, d, x_m, age, gen, input_lengths, txts, txt_lengths):
        ...
        # vslt_embedding = vslt_embedding[:,-1]
        ...
        final_output = torch.cat([txt_cls_output, vslt_embedding], 1)
