...
# late concat V-grud T-trans
class LATEFUSION_VSLT_GRUD_TXT_TRANSFORMER(nn.Module):
    ...
    def forward(self, x, h, m, d, x_m, age, gen, input_lengths, txts, txt_lengths):
        ...
        classInput = torch.cat((vslt_embedding, txt_cls_output, ageTensor, genTensor), 1)
