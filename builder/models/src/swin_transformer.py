...
def _swin_transformer(
    ...
    **kwargs: Any,
    ...
    # print("Duct", model.state_dict())
    if weights is not None:
        mod_weights = weights.get_state_dict(progress=progress)
        # exit(1)
        mod_weights["features.0.0.weight"] = torch.nn.Parameter(torch.sum(mod_weights["features.0.0.weight"], dim=1, keepdim=True))
...
def swin_t_m(*, weights: Optional[Swin_T_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_s_m(*, weights: Optional[Swin_S_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_b_m(*, weights: Optional[Swin_B_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_v2_t_m(*, weights: Optional[Swin_V2_T_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_v2_s_m(*, weights: Optional[Swin_V2_S_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_v2_b_m(*, weights: Optional[Swin_V2_B_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
