...
def missing_trainer(args, iteration, train_x, static_x, input_lengths, train_y, 
                                            ...
                                            seq_lengths=None, x_img=None, exist_img=None, x_txt=None, txt_lengths=None, imgtxt_time=None, missing=None, reports_tokens=None, reports_lengths=None, criterion_aux = None):
    ...
    if flow_type == "train":
        ...
        with torch.cuda.amp.autocast():
            ...
            if aux is not None:
                ...
                if args.model == "MMVED":
                    loss = loss + (args.auxiliary_loss_weight * aux)
