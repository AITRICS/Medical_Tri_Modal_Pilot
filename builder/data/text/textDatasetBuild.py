...
fileNm = "builder/data/text/textDataset/" + datasetName + "_" + dtype +"_" + token_type +"_textDataset.txt"
...
if token_type == "bpe":
    ...
    outputFile.close()
    testFile = open("builder/data/text/textDataset/" + datasetName + "_test_bpe_textDataset.txt", "w")
    ...
    testFile.close()
    encoderFileHandler = open("builder/data/text/textDatasetEncoder/" + datasetName + "_" + str(vocabCount) + ".obj", 'wb')
...
if token_type == "bert":
    ...
    with os.scandir(data_path) as it:
        ...
        outputFile.close()
        testFile = open("builder/data/text/textDataset/" + datasetName + "_test_bert_textDataset.txt", "w")
    ...
    testFile.close()
    encoderFileHandler = open("builder/data/text/textDatasetEncoder/" + datasetName + ".obj", 'wb')
