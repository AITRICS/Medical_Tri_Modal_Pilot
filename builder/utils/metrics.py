...
class Evaluator(object):
    def __init__(self, args):
        ...
        self.y_pred_multi = []
        self.rmse = []
        self.nauroc = MulticlassAUROC(num_classes=13, average="none")
        self.nauprc = MulticlassAveragePrecision(num_classes=13, average="none")
        self.nf1 = MulticlassF1Score(num_classes=13, average="none").to(args.device)
        
        self.wauroc = MulticlassAUROC(num_classes=13, average="weighted")
        self.wauprc = MulticlassAveragePrecision(num_classes=13, average="weighted")
        self.wf1 = MulticlassF1Score(num_classes=13, average="weighted").to(args.device)
    ...
    def performance_metric(self):
        ...
        preds = self.y_pred_multi.reshape(-1, 13).cuda()
