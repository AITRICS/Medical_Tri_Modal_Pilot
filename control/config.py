...
parser.add_argument('--t_0', '-tz', type=int, default=25, help='T_0 of cosine annealing scheduler')
...
parser.add_argument('--txt-tokenization', type=str, default="bpe", choices=["word", "character", "bpe", "bert"])
